...
Cypress.Commands.add('checkPageLoadAndComponents', () => {
  ...
  cy.get('a.MuiLink-root[href="/accounts/recover/password/find?continue_to=https%3A%2F%2Felice.io%2Fuser%2Fprofile&amp;lang=ko"]', { timeout: 10000 }).should('contain', '비밀번호를 잊어버리셨나요?');
